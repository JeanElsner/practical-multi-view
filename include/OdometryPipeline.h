#ifndef ODOMETRY_PIPELINE_H
#define ODOMETRY_PIPELINE_H
#include "Feature.h"
#include "Frame.h"
...
class OdometryPipeline : private dlib::multithreaded_object
{
private:
	bool init = false;
	bool init3d = false;
...
public:
	...
	/**
		...
		@param src First frame
		@param next Second frame
	**/
	...
	*/
	...
	class OdometryPipelineException : public std::runtime_error
	{
	public:
		OdometryPipelineException(const char* msg): std::runtime_error(msg) { }
	};
	...
	*/
	OdometryPipeline(std::string cfg);

	OdometryPipeline() : job_pipe(605) {};
